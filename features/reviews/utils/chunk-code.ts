//  utility file copy paste

import type { CodeChunk, PrFile } from "../types/review";
...
//   function ka kaam= prfiles ke patches ko emmbbedable code chunk record ke ander split krega
